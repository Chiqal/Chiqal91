...
ql = QHAL.LINE()
ql.login(token='Eo6M16kJ1FxIquv8XHa1.iU0HVzEKkrCM/Lo3vS4Vaq.uF8qxehaYDXcD+1gGM014rstsM2VVi05BYAXjrbGszc=')
ql.loginResult()
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["Don't Tag Me! iam Bussy!, ",cName + "Ada perlu apa, ?",cName + " pc aja klo urgent! sedang sibuk,", "kenapa, ", cName + " kangen?","kangen bilang gak usah tag tag, " + cName, "Chiqal Sibuk, " + cName, "Chiqal Off, " + cName + "Bilang Kalo kangen A ChiqalFV mah", "No tag A ChiqaLFV, " + cName + "?","aya naon, ?" + cName + "Tersangkut -_-" + cName + "Chiqal Lagi Coli jangan ganggu" + cName + "Apa Sayang ?"]
